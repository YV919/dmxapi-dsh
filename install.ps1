...
$dmxPackage = Join-Path $PSScriptRoot 'artifacts\dsh-dmxapi-0.1.9.tgz'
...
Copy-Item -LiteralPath $dmxPackage -Destination (Join-Path $dmxPackageStore 'dsh-dmxapi-0.1.9.tgz') -Force
& npx.cmd --yes '@deepseek-ai/dsh@0.1.5-rc.2' plugin --profile $Profile add 'file:local-packages/dsh-dmxapi-0.1.9.tgz'
